...
module.exports = class Settings extends React.Component {
	...
	render() {
		...
		return (
			<div>
				<h5 className='h5-18_1nd title-3sZWYQ size12-3R0845 height16-2Lv3qA weightSemiBold-NJexzi marginBottom8-AtZOdT'>Manage favorited friends</h5>
				...
				<div
					className='bf-user-settings guildSettingsAuditLogsUserFilterPopout-bY1CFU pc-guildSettingsAuditLogsUserFilterPopout elevationBorderHigh-2WYJ09 pc-elevationBorderHigh'
					popoutKey='bf-users'
				>
					<PopoutListSearchBar
						autoFocus={false}
				...
				<div className='description-3_Ncsb formText-3fs7AJ marginBottom20-32qID7 modeDefault-3a2Ph1 primary-jw0I4K'>
					Customize notification sounds specifically for favorited friends. You can put a link to an MP3 file in the textbox, or leave it blank to
					...
					<div className='bf-notification-sounds' style={{ marginBottom: '16px' }}>
						<div style={{ float: 'left' }}>
							<Text className='title-31JmR4 titleDefault-a8-ZSr medium-zmzTW- size16-14cGz5 height20-mO2eIN'>
								<label className='title-31JmR4 titleDefault-a8-ZSr medium-zmzTW- size16-14cGz5 height20-mO2eIN'>{Sounds[sound]}</label>
							</Text>
						</div>
						...
						<div style={{ float: 'right' }}>
							<div style={{ float: 'left' }}>
								<button
									...
									className='bf-notification-sounds-icon button-1Pkqso iconButton-eOTKg4 button-38aScr lookOutlined-3sRXeN colorWhite-rEQuAQ buttonSize-2Pmk-w iconButtonSize-U9SCYe grow-q77ONN'
								/>
							</div>
